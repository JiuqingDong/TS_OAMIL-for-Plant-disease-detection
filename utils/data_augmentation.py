...
if __name__ == "__main__":
    ...
    org_datasets = 'GWHD/'
    aug_datasets = 'GWHD/'
    IMG_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OA-MIL-main/data/" + org_datasets +set
    XML_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OA-MIL-main/data/" + org_datasets + "/labels_control_class/"+set+"_xml"
    # 存储增强后的XML文件夹路径
    AUG_XML_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OA-MIL-main/data/" + aug_datasets + "/labels_control_class/"+set+"_xml"
    try:
    ...
    mkdir(AUG_XML_DIR)
    # 存储增强后的影像文件夹路径
    AUG_IMG_DIR = "/Users/jiuqingdong/Documents/Pycharm_Project_Code/OA-MIL-main/data/" + aug_datasets +set
    try:
    ...
    seq4 = iaa.Sequential([
        iaa.Fliplr(1),  # 对50%的图像做镜像翻转
        # iaa.ContrastNormalization((0.75, 1.5), per_channel=True),
        iaa.Crop(percent=(0, 0.05), keep_size=True),
        # iaa.Multiply((1.2, 1.5)),  # 改变亮度
        #iaa.GaussianBlur(sigma=(0, 0.5)),  # iaa.GaussianBlur(0.5),
        iaa.Affine(
            translate_percent={"x": (-0.10, 0.1), "y": (-0.1, 0.1)},

...
all_class = {'blossom_end_rot', 'graymold', 'powdery_mildew', 'spider_mite', 'spotting_disease'} #, 'healthy', 'background', 'unknown'}
    ...
    for name in tqdm(os.listdir(xml_path)):
        ...
        if os.path.exists(image_name):
            ...
            if len(allObjects) == 0:
                ...
                _xml_name = _xml_name.replace('unlabeled', 'unlabeled_xml')
